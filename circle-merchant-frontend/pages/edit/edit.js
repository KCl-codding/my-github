...
const EDIT_MERCHANT_NICKNAME = API_CONFIG.BASE_URL + API_CONFIG.USER.edit_merchant_nickname;
const EDIT_MERCHANT_GENDER = API_CONFIG.BASE_URL + API_CONFIG.USER.edit_merchant_gender;
const EDIT_MERCHANT_REGION = API_CONFIG.BASE_URL + API_CONFIG.USER.edit_merchant_region;
...
Page({
  ...
  updateLocalUserInfo(field, value) {
    try {
      const app = getApp();
      let userInfo = wx.getStorageSync(app.getStorageKey('userInfo'));  // 加前缀
      if (!userInfo) {
        userInfo = {};
      }
